...
export function CardItem({ item }) {
  ...
  return (
    <div
      className="w-full relative before:content-[''] before:block before:float-left before:pt-[150%] after:content-[''] after:table after:clear-both bg-[#f2f2f2] rounded-[1.125rem] flex flex-col flex-shrink-0 overflow-hidden cursor-pointer"
      onClick={() =>
